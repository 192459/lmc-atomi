...
python prox_lmc_deconv.py --N=1000 --tau=0.3 --snr=30 --gamma_pdhg=15. --img='camera' --alg='ULPDA'
python prox_lmc_deconv.py --N=1000 --tau=0.3 --snr=30 --gamma_pdhg=15. --img='camera' --alg='MYULA'
