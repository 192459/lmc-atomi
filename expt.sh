...
python prox_lmc_deconv.py --N=100 --tau=0.3 --sigma=0.75 --gamma_pdhg=15. --image='camera' --alg='ULPDA'
python prox_lmc_deconv.py --N=100 --tau=0.3 --sigma=0.75 --gamma_pdhg=15. --image='camera' --alg='MYULA'
