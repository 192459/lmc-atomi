...
def lmc_gaussian_mixture(gamma_ula=5e-2, gamma_mala=5e-2, 
    ...
    ### KL divergence
    # kl_ula = entropy(Z1, Z2)
    # kl_mala = entropy(Z1, Z3)
    # kl_pula = entropy(Z1, Z4)
    # kl_ihpula = entropy(Z1, Z5)
    # kl_mla = entropy(Z1, Z6)
    # print(kl_ula)
    ...
    wass_ula = ot.emd2(a, b, M_ula)
    wass_mala = ot.emd2(a, b, M_mala)
    wass_pula = ot.emd2(a, b, M_pula)
    wass_ihpula = ot.emd2(a, b, M_ihpula)
    wass_mla = ot.emd2(a, b, M_mla)
    print(f'Wasserstein distance between true samples and ULA samples: {wass_ula**.5}')
    print(f'Wasserstein distance between true samples and MALA samples: {wass_mala**.5}')
    print(f'Wasserstein distance between true samples and PULA samples: {wass_pula**.5}')
    print(f'Wasserstein distance between true samples and IHPULA samples: {wass_ihpula**.5}')
    print(f'Wasserstein distance between true samples and MLA samples: {wass_mla**.5}')
    ...
    # fig3.savefig(f'./fig/fig_n{n}_gamma{gamma_ula}_{K}_kl_div.eps', dpi=1200)
