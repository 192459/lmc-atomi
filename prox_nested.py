...
def ProxNestedSamplingMYMALA(X0, LikeliL, proxH, proxB, params, options):
    r"""Executes the proximal nested sampling algorithm with MYMALA
...
def ProxNestedSamplingPDMALA(X0, LikeliL, proxH, proxB, params, options):
    r"""Executes the proximal nested sampling algorithm with PDMALA
