...
def prox_lmc_deconv(gamma_mc=5e-1, gamma_me=5e-1, sigma=0.75, tau=0.03, N=10000, 
    ...
    if compute_MAP:
        ...
        print(f"SNR of FISTA MAP image with TV (M4): {signal_noise_ratio(img, iml12_6_map)}")
        print(f"SNR of FISTA MAP image with MC-TV (M5): {signal_noise_ratio(img, iml12_6_mc_map)}")
        print(f"SNR of FISTA MAP image with ME-TV (M6): {signal_noise_ratio(img, iml12_6_me_map)}")
        print(f"SNR of FISTA MAP image with TV (M7): {signal_noise_ratio(img, iml12_7_map)}")
        print(f"SNR of FISTA MAP image with MC-TV (M8): {signal_noise_ratio(img, iml12_7_mc_map)}")
        print(f"SNR of FISTA MAP image with ME-TV (M9): {signal_noise_ratio(img, iml12_7_me_map)}")
        ...
        print(f"PSNR of FISTA MAP image with TV (M4): {psnr(img, iml12_6_map)}")
        print(f"PSNR of FISTA MAP image with MC-TV (M5): {psnr(img, iml12_6_mc_map)}")
        print(f"PSNR of FISTA MAP image with ME-TV (M6): {psnr(img, iml12_6_me_map)}")
        print(f"PSNR of FISTA MAP image with TV (M7): {psnr(img, iml12_7_map)}")
        print(f"PSNR of FISTA MAP image with MC-TV (M8): {psnr(img, iml12_7_mc_map)}")
        print(f"PSNR of FISTA MAP image with ME-TV (M9): {psnr(img, iml12_7_me_map)}")
        ...
        print(f"MSE of FISTA MAP image with TV (M4): {mse(img, iml12_6_map)}")
        print(f"MSE of FISTA MAP image with MC-TV (M5): {mse(img, iml12_6_mc_map)}")
        print(f"MSE of FISTA MAP mean image with ME-TV (M6): {mse(img, iml12_6_me_map)}")
        print(f"MSE of FISTA MAP mean image with TV (M7): {mse(img, iml12_7_map)}")
        print(f"MSE of FISTA MAP mean image with MC-TV (M8): {mse(img, iml12_7_mc_map)}")
        print(f"MSE of FISTA MAP mean image with ME-TV (M9): {mse(img, iml12_7_me_map)}")
